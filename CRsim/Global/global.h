...
const int   TOTAL_CHAN_NUM  = 60; // total number of channels in the whole spectrum
...
const int   TOTAL_TIME_SLOT  = 5000; //simulation time slots
const int   SIMULATION_REPEAT_TIME = 1000; //Do how many simulations
