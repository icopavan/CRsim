...
vector<int> divide_4m2(int x)
{
    ...
    ans.resize(2);
    if(t % 2 == 0){
        ans[0] = 4*q+1; ans[1] = 4*q+1;
    }
    else{
        ans[0] = 4*(q+1)+1; ans[1] = 4*q+1;
    }
    return ans;
}
...
vector<int> divide_4m3(int x)
{
    ...
    ans.resize(3);
    if(t % 2 == 0){
        ans[0] = 4*(q+1); ans[1] = 4*q+1; ans[2] = 4*q+1;
    }
    else{
        ans[0] = 4*(q+1); ans[1] = 4*(q+1)+1; ans[2] = 4*q+1;
    }
    return ans;
}
